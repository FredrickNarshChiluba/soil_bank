                ...
                <div class="tile-body row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('Sample_ID') is-invalid @enderror" type="text" name="Sample_ID" id="Sample_ID" value="{{ old('Sample_ID') }}" />
                        ...
                        <div class="form-group">
                            <label class="control-label" for="Soil_type">Soil Color <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('Soil_type') is-invalid @enderror" type="text" name="soil_color" id="soil_color" value="{{ old('soil_color') }}" />
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('Soil_texture_sand') is-invalid @enderror" type="text" name="Soil_texture_sand" id="Soil_texture_sand" value="{{ old('Soil_texture_sand') }}" />
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('Soil_texture_clay') is-invalid @enderror" type="text" name="Soil_texture_clay" id="Soil_texture_clay" value="{{ old('Soil_texture_clay') }}" />
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('Soil_texture_silt') is-invalid @enderror" type="text" name="Soil_texture_silt" id="Soil_texture_silt" value="{{ old('Soil_texture_silt') }}" />
